                ...
                <div className="footer-content">
                    <div className="footer-content-column">
                        <div className="footer-logo">
                            <span className="footer-logo-link" >
                                ...
                                <h1>Ganesh <i className="fa fa-code"></i></h1>
                            </span>
                        </div>
                    ...
                    <div className="footer-content-column">
                        <div className="footer-menu">
                            <h2 className="footer-menu-name"> GaneshOnlineStore.in</h2>
                        ...
                        <div className="footer-menu">
                            ...
                            <ul id="menu-quick-links" className="footer-menu-list">
                                ...
                                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                                    <span  rel="noopener noreferrer">Service Status</span>
                                </li>
                    ...
                    <div className="footer-content-column">
                        ...
                        <div className="footer-call-to-action">
                            ...
                            <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="tel:0124-64XXXX"  >+91 9302196294 </a></p>
                        </div>
                        <div className="footer-call-to-action">
                            <h2 className="footer-call-to-action-title"> You Mail Us</h2>
                            <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="mailto:rathorganesh35@gmail.com"  >rathorganesh35@gmail.com </a></p>
                        </div>
                    </div>
                    <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
                        ...
                        <a className="footer-social-link linkedin" href="https://www.linkedin.com/in/ganesh-rathor-92388422b/"  >
                        ...
                        <a className="footer-social-link twitter" href="https://twitter.com/Ganesh57263610"  >
                        ...
                        <a className="footer-social-link youtube" href="https://codepen.io/ganesh-rathor"  >
                        ...
                        <a className="footer-social-link github" href="https://github.com/Ganesh-Rathor"  >
                ...
                <div className="footer-copyright">
                    <div className="footer-copyright-wrapper">
                        <p className="footer-copyright-text">
                            <span className="footer-copyright-link"  > ©2022. | Copied By Ganesh Rathor. | All rights reserved. </span>
                        </p>
                    </div>
                </div>
            </footer>
